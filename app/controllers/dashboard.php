<?php
	...
	class Dashboard extends Controller{
		...
		function insertarContenido(){
				...
				$dir_subida="/home/contents/web/contents.cesnuria.com/public_html/contents/pub/img/";
				//$dir_subida_juegos=APP_W.'pub/js/';
				$dir_subida_juegos="/home/contents/web/contents.cesnuria.com/public_html/contents/pub/js/";
		...
		function insertarJuego($a, $b){
			...
			if ($zip->open("/home/contents/web/contents.cesnuria.com/public_html/contents/pub/js/".$b) === TRUE) {
			    $zip->extractTo("/home/contents/web/contents.cesnuria.com/public_html/contents/pub/js/");
			    $zip->close();
			    //echo 'ok';
			} else {
			    //echo 'failed';
			...
			$e="/home/contents/web/contents.cesnuria.com/public_html/contents/pub/js/".$d[0].'/index.html';
