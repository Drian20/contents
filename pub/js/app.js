...
{
  $.ajax({
    url: '/contents/desktop/mostrar_cuentos_ini', 
    dataType: 'json',
    success: function(output)
    {
...
{
  $.ajax({
    url: '/contents/desktop/mostrar_cuentos_ini_all', 
    dataType: 'json',
    success: function(output)
    {
...
{
  $.ajax({
    url: '/contents/desktop/mostrar_cuentos_inter', 
    dataType: 'json',
    success: function(output)
    {
...
{
  $.ajax({
    url: '/contents/desktop/mostrar_cuentos_inter_all', 
    dataType: 'json',
    success: function(output)
    {
...
{
  $.ajax({
    url: '/contents/desktop/mostrar_cuentos_avan', 
    dataType: 'json',
    success: function(output)
    {
...
{
  $.ajax({
    url: '/contents/desktop/mostrar_cuentos_avan_all', 
    dataType: 'json',
    success: function(output)
    {
...
{
  $.ajax({
    url: '/contents/desktop/mostrar_cuentos_ini_e', 
    type: "POST",
    data:{'id': id,
          'num': num},
    dataType:'json',
...
{
  $.ajax({
    url: '/contents/desktop/mostrar_cuentos_inter_e', 
    type: "POST",
    data:{'id': id,
          'num': num},
    dataType:'json',
...
{
  $.ajax({
    url: '/contents/desktop/mostrar_cuentos_avan_e', 
    type: "POST",
    data:{'id': id,
          'num': num},
    dataType:'json',
...
{
  $.ajax({
    url: '/contents/desktop/mostrar_juegos_ini', 
    type: "POST",
    data:{'id': id},
    dataType:'json',
    success: function(output)
...
{
  $.ajax({
    url: '/contents/desktop/mostrar_juegos_inter', 
    type: "POST",
    data:{'id': id},
    dataType:'json',
    success: function(output)
...
{
  $.ajax({
    url: '/contents/desktop/mostrar_juegos_avan', 
    type: "POST",
    data:{'id': id},
    dataType:'json',
    success: function(output)
...
{
  $.ajax({
    url: '/contents/comment/showComments',
    dataType: 'json',
    success: function(output)
    {
      showComments(output);
...
//FRET
    ...
    function TablaUsuarios(){
        ...
        $.ajax({
            url:'/contents/dashboard/mostrarUsuarios',
            dataType:'json',
            success:function(output){
                //console.log(output);
                ...
                for(var i=0;i<tam;i++)
                {
                    ...
                    else if(y==2)
                    {
                        ...
                        $.ajax({
                            async: false,
                            url:'/contents/dashboard/selPapa',
                            method:'POST',
            ...
            error:function(){
                alert("Error al intentar cargar la tabla de usuarios, sentimos las molestias.\n\nContents");
            }
        });     
    }
    ...
    $("#modificar").click(function(){
        ...
        $("tr input[type=checkbox]:checked").each(function(){
           ...
           alert(x0+", "+x1+", "+x2+", "+x3+", "+x4+", "+x5+", "+x6+", "+x7+", "+x8+", "+x9);
            $.ajax({
                url:"/contents/dashboard/modificar",
                method:'POST',
